"""
Django settings for juice_production project.
...
SECRET_KEY = 'django-insecure-w$au6vh5c^xn7l4g4(wz6k&trmuv#nq6wjg=x#&zbffs$+1a1c'
...
ROOT_URLCONF = 'juice_production.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'juice_app.context_processors.beauty_settings',
            ],
        },
    },
]

WSGI_APPLICATION = 'juice_production.wsgi.application'
...
BEAUTY_PARLOR_NAME = 'Eloynel Fruits'
